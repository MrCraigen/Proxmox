...
function update_script() {
  ...
  if check_for_gh_release "isponsorblocktv" "dmunozv04/iSponsorBlockTV"; then
    ...
    CLEAN_INSTALL=1 fetch_and_deploy_gh_release "isponsorblocktv" "dmunozv04/iSponsorBlockTV" "singlefile" "latest" "/opt/isponsorblocktv" "iSponsorBlockTV-aarch64-linux"
